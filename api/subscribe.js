...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Vamos apenas verificar se já existe uma inscrição sem verificar o Auth
    // Na landing page o usuário não está autenticado ainda, apenas se inscreve para emails
